...
const statuses = [
  { value: "backlog", label: "待办池", color: issueStatusText.backlog ?? issueStatusTextDefault },
  ...
  { value: "in_review", label: "评审中", color: issueStatusText.in_review ?? issueStatusTextDefault },
